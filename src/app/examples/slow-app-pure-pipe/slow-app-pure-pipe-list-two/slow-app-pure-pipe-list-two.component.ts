...
@Component({
  selector: 'app-slow-app-pure-pipe-list-two',
  templateUrl: './slow-app-pure-pipe-list-two.component.html',
  styleUrls: ['./slow-app-pure-pipe-list-two.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SlowAppPurePipeListTwoComponent {
